...
class Login {
  ...
  buttonSignUp = new ButtonCommon("btn_sign", "button", "Sign up");
    buttonAdmin = new ButtonCommon("btn_admin", "button", "Admin");
  ...
  constructor() {
    ...
    this.form.appendChild(this.inputCheckBox.html());
      ...
      this.form.appendChild(this.buttonAdmin.html());
      this.form.insertAdjacentHTML("beforeend", "<hr>");
    this.form.appendChild(div);
    this.form.appendChild(this.buttonSignUp.html());

      this.buttonAdmin.html().addEventListener("click", this.handleAdmin);
    this.buttonSignUp
      .html()
